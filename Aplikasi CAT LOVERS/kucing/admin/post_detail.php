...
echo '<a href="admincouple.php"><button class="button" value="Tambah">Kembali</button></a>';
}else{
echo '<a href="adminadopt.php"><button class="button" value="Tambah">Kembali</button></a>';	
}
?>
</td>
	</tr>
