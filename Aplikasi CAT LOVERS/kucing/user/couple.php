...
while($loop = mysql_fetch_assoc($runselect)){
  ...
  echo "<a href='pasangkan.php?idkucing=".$loop['id_kucing']."&idcouple=".$loop['id_transaksi']."'><button class='button' type='submit' name='submit'>Pasangkan</button></a></td>";
  echo "</tr>";
  echo "<tr>";
